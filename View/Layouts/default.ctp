...
<html xmlns="http://www.w3.org/1999/xhtml" lang="zh-TW">
    ...
    <body>
        <div class="container">
            <div id="header">
                <h1><?php echo $this->Html->link('賄選實價登錄', '/'); ?></h1>
            </div>
            <div id="content">
                <div class="btn-group">
                    <?php if ($this->Session->read('Auth.User.id')): ?>
                        <?php echo $this->Html->link('案件', '/admin/issues', array('class' => 'btn btn-default')); ?>
                        <?php echo $this->Html->link('點', '/admin/points', array('class' => 'btn btn-default')); ?>
